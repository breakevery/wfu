...
| 插件 | 版本 | 能力 | 说明 |
|------|------|------|------|
| **EnglishPack** | 1.0.0 | `ILanguagePack` | 英文语言包，覆盖菜单/工具栏/状态栏共 **34** 条 key |
...
> ② 补全 EnglishPack 8 个缺失 key——✅ M5-2 已完成；③ 状态栏接入语言包——✅ M5-3 已完成；④ 发布自动复制 Plugins——待做。
